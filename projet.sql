...
(2, 1, 1, 'Title 2', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.', NULL, '0000-00-00'),
(3, 1, 1, 'Title 3', 'Aenean fermentum. Donec ut mauris eget massa tempor convallis. Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.', NULL, '0000-00-00'),
(4, 2, 1, 'Title 1', 'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.', NULL, '0000-00-00'),
...
(7, 3, 1, 'Title 1', 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', NULL, '0000-00-00'),
(8, 3, 1, 'Title 2', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', NULL, '0000-00-00'),
...
--
ALTER TABLE `sub`
  MODIFY `idsub` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
